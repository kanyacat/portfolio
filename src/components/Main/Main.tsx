			...
			<Container>
				<div className={styles.content}>
					...
					<div className={styles.info}>
						<p>Вы находитесь на странице моих небольших пет-проектов</p>
						<p>
						...
						<p>
							Всё это время проходила небольшие курсы и занималась
							самообучением.
						</p>
						<p>
							Вы можете посмотреть мои работы или связаться со мной по ссылкам
							ниже.
						</p>
					</div>
